...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASED] = LAYOUT(
        ...
        KC_TAB,   C_CTL,    KC_X,     KC_C,     KC_V,     KC_B,      KC_N,     KC_M,     KC_COMM,  KC_DOT,   C_ALT,    KC_RALT,
                                      KC_ESC,   L_NUM,    C_CMD,     KC_LSFT,  L_SYM,    KC_ENT
    ),
    [_NUMBER] = LAYOUT(
                  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,     KC_NO,    KC_1,     KC_2,     KC_3,     KC_4,
                  KC_LGUI,  KC_LALT,  KC_LCTL,  KC_LSFT,  MOSE,      KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, KC_MINS,
        KC_NO,    KC_PLUS,  KC_EQL,   KC_COMM,  KC_DOT,   GAME,      KC_NO,    KC_5,     KC_6,     KC_7,     KC_8,     KC_NO,
    ...
    [_MOUSE] = LAYOUT(
                  ...
                  KC_NO,    KC_MS_L,  KC_MS_D,  KC_MS_R,  BASE,      KC_NO,    KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_NO,
        KC_NO,    KC_NO,    KC_BTN4,  KC_NO,    KC_BTN5,  KC_NO,     KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,
                                      KC_BTN3,  KC_BTN2,  KC_BTN1,   KC_NO,    KC_NO,    KC_NO
    ),
    [_GAME] = LAYOUT(
                  KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,      KC_NO,    KC_PGDN,  KC_UP,    KC_PGUP,  KC_NO,
                  KC_LCTL,  KC_A,     KC_S,     KC_D,     KC_F,      KC_NO,    KC_LEFT,  KC_DOWN,  KC_RIGHT, KC_NO,
        KC_ESC,   KC_LALT,  KC_Z,     KC_X,     KC_C,     KC_V,      KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,
                                      KC_LSFT,  L_GMN,    KC_SPC,    BASE,     KC_NO,    KC_NO
    ),
    [_GAMENR] = LAYOUT(
        ...
        KC_ENT,   KC_TRNS,  KC_7,     KC_8,     KC_9,     KC_TRNS,      KC_TRNS,    KC_TRNS,  KC_TRNS,    KC_TRNS,   KC_TRNS,    KC_TRNS,
